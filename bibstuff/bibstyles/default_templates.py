...
book = '(%(year)s) *%(title)s*. %(address)s: %(publisher)s. %(url)s',
article  = '(%(year)s) %(title)s. *%(journal)s* %(volume)s, %(pages)s. %(url)s',
...
inbook = '(%(year)s) %(title)s. In: *%(booktitle)s*, %(pages)s.  %(address)s: %(publisher)s. %(url)s',
misc = '(%(year)s)  %(title)s. %(url)s',
